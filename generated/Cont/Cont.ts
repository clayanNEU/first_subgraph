...
export class Cont__punksOfferedForSaleResult {
  value0: boolean;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class Cont__punkBidsResult {
  value0: boolean;
  value1: BigInt;
  value2: Address;
  value3: BigInt;
...
export class Cont extends ethereum.SmartContract {
  static bind(address: Address): Cont {
    return new Cont("Cont", address);
  }
  ...
  punksOfferedForSale(param0: BigInt): Cont__punksOfferedForSaleResult {
    ...
    return new Cont__punksOfferedForSaleResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt(),
  ...
  try_punksOfferedForSale(
    param0: BigInt
  ): ethereum.CallResult<Cont__punksOfferedForSaleResult> {
    ...
    return ethereum.CallResult.fromValue(
      new Cont__punksOfferedForSaleResult(
        value[0].toBoolean(),
        value[1].toBigInt(),
        value[2].toAddress(),
        value[3].toBigInt(),
  ...
  punkBids(param0: BigInt): Cont__punkBidsResult {
    let result = super.call(
      "punkBids",
    ...
    return new Cont__punkBidsResult(
      result[0].toBoolean(),
      result[1].toBigInt(),
      result[2].toAddress(),
      result[3].toBigInt()
  ...
  try_punkBids(param0: BigInt): ethereum.CallResult<Cont__punkBidsResult> {
    let result = super.tryCall(
      "punkBids",
      "punkBids(uint256):(bool,uint256,address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
